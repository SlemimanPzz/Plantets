class Sun {
    ...
    draw(gl, projectionMatrix, viewMatrix, light) {
        ...
        if (this.material.getUniform("u_texture") != undefined) {
            ...
            gl.texImage2D(gl.TEXTURE_2D, level, internalFormat, texture_width, texture_height, border, format, type, data);

            gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.LINEAR);
            let bloomFrameBuffer = gl.createFramebuffer();
            gl.bindFramebuffer(gl.FRAMEBUFFER, bloomFrameBuffer);
            gl.framebufferTexture2D(gl.FRAMEBUFFER, gl.COLOR_ATTACHMENT0, gl.TEXTURE_2D, this.material.texture, level);
