class MoveCamera {
    ...
    /** */
    moveForward() {
        let dir = Vector3.subtract(this.coi, this.pos).normalize();
        this.pos = Vector3.add(this.pos, dir);
        this.coi = Vector3.add(this.coi, dir);

    }
    /** */
    moveBackward() {
        let dir = Vector3.subtract(this.coi,this.pos).normalize();
        this.pos = Vector3.subtract(this.pos, dir);
        this.coi = Vector3.subtract(this.coi, dir);
    }
